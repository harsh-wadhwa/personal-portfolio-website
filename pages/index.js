      ...
      <div className="content mt-12 sm:mt-24">
        ...
        <ul className="mt-8">
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            ...
            >
              <Image
                src="/static/images/workxp/godaddy_logo.png"
                alt="GoDaddy"
                width="50px"
                height="50px"
            ...
            <div className="flex min-w-0 flex-col justify-center">
              ...
              <p className="flex items-center truncate">
                <span className="flex-1 truncate text-zinc-500 dark:text-zinc-400">SDE-II</span>
              </p>
            </div>
          </li>          
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
            ...
            <div className="flex min-w-0 flex-col justify-center">
              ...
              <p className="flex items-center truncate">
                <span className="flex-1 truncate text-zinc-500 dark:text-zinc-400">SDE-I</span>
              </p>
            </div>
          </li>
          <li className="dark:text-zinc-350 my-5 flex items-center gap-4 text-zinc-500">
